...
public static class BoundingBoxExtensions {
    ...
    public static Solid CreateSolid(this BoundingBoxXYZ bb) {
        ...
        XYZ pt0 = new(bb.Min.X, bb.Min.Y, bb.Min.Z);
        XYZ pt1 = new(bb.Max.X, bb.Min.Y, bb.Min.Z);
        XYZ pt2 = new(bb.Max.X, bb.Max.Y, bb.Min.Z);
        XYZ pt3 = new(bb.Min.X, bb.Max.Y, bb.Min.Z);
    ...
    public static BoundingBoxXYZ IncreaseBoundingBox(this BoundingBoxXYZ bb, double offset = 5) {
        XYZ offsetVec = new(offset, offset, offset);
    ...
    public static BoundingBoxXYZ TransformBoundingBox(this BoundingBoxXYZ bb, Transform transform) {
        ...
        XYZ tpt0 = transform.OfPoint(pt0);
        XYZ tpt1 = transform.OfPoint(pt1);
        XYZ tpt2 = transform.OfPoint(pt2);
