...
public static class ElementExtensions {
    private static readonly Options _options = new() {
        ComputeReferences = true, IncludeNonVisibleObjects = false, DetailLevel = ViewDetailLevel.Fine
    };

    /// <summary>
    ///     Возвращает все <see cref="Solid" /> объекты из <see cref="Autodesk.Revit.DB.Element" /> с
    ///     <see cref="Autodesk.Revit.DB.Options" /> по умолчанию<br />
    ...
    /// <summary>
    ///     Возвращает все <see cref="Solid" /> объекты из <see cref="Autodesk.Revit.DB.Element" /> с заданными
    ///     <see cref="Autodesk.Revit.DB.Options" /><br />
