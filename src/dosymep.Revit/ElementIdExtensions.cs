...
public static class ElementIdExtensions {
    ...
    /// <returns>
    ///     Возвращает true - если идентификатор элемента null или
    ///     <see cref="Autodesk.Revit.DB.ElementId.InvalidElementId" />, иначе false.
    /// </returns>
    ...
    /// <param name="elementId">Идентификатор элемента.</param>
    /// <returns>
    ///     Возвращает true - если идентификатор элемента не null или
    ///     <see cref="Autodesk.Revit.DB.ElementId.InvalidElementId" />, иначе false.
    /// </returns>
