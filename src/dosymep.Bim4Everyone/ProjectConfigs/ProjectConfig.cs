...
public abstract class ProjectConfig<TProjectSettings> : ProjectConfig
    ...
    public TProjectSettings AddSettings(string documentName) {
        ...
        TProjectSettings projectSettings = new() {ProjectName = GetProjectName(documentName)};
    ...
    /// <param name="documentName">Наименование документа.</param>
    /// <returns>
    ///     Возвращает настройки проекта по наименованию документа. Если настройки проекта не были найдены, возвращает
    ///     null.
    /// </returns>
