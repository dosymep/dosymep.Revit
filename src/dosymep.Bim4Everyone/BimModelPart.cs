...
public class BimModelPart : IEquatable<BimModelPart> {
    ...
    ///     AR
    /// </summary>
    public static readonly BimModelPart ARPart = new() {Id = "AR", Name = "АР", Description = "Архитектурные решения"};

    /// <summary>
    ///     KR
    /// </summary>
    public static readonly BimModelPart KRPart = new() {Id = "KR", Name = "КР", Description = "Конструктивные решения"};

    /// <summary>
    ///     KM
    /// </summary>
    public static readonly BimModelPart KMPart = new() {
        Id = "KM", Name = "КМ", Description = "Конструкции металлические"
    };

    /// <summary>
    ///     OV
    /// </summary>
    public static readonly BimModelPart OVPart = new() {Id = "OV", Name = "ОВК", Description = "Вентиляция"};

    /// <summary>
    ///     ITP
    /// </summary>
    public static readonly BimModelPart ITPPart = new() {Id = "ITP", Name = "ИТП", Description = "ЦТП/ИТП"};

    /// <summary>
    ///     HC
    /// </summary>
    public static readonly BimModelPart HCPart = new() {Id = "HC", Name = "ХЦ", Description = "Хладоцентр"};

    /// <summary>
    ///     VK
    /// </summary>
    public static readonly BimModelPart VKPart = new() {Id = "VK", Name = "ВК", Description = "Водоснабжение"};

    /// <summary>
    ///     ЕОМ
    /// </summary>
    public static readonly BimModelPart EOMPart =
        new() {Id = "EOM", Name = "ЭОМ", Description = "Система электроснабжения"};

    /// <summary>
    ///     EG
    /// </summary>
    public static readonly BimModelPart EGPart = new() {Id = "EG", Name = "ЭГ", Description = "Молниезащита"};

    /// <summary>
    ///     SS
    /// </summary>
    public static readonly BimModelPart SSPart = new() {Id = "SS", Name = "CC", Description = "Слаботочные системы"};

    /// <summary>
    ///     GP
    /// </summary>
    public static readonly BimModelPart GPPart = new() {
    ...
    public static readonly BimModelPart KOORDPart =
        new() {Id = "KOORD", Name = "КООРД", Description = "Координационный файл"};
    ...
    public static readonly BimModelPart VNPart =
        new BimModelSubPart {Parent = OVPart, Id = "VN", Name = "ВН", Description = "Системы общеобменной вентиляции"};
    ...
    public static readonly BimModelPart PTPart =
        new BimModelSubPart {Parent = VKPart, Id = "PT", Name = "ПТ", Description = "Система водяного пожаротушения"};
