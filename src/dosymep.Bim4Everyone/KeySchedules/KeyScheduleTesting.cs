...
public class KeyScheduleTesting {
    ...
    ///     Проверяемая спецификация.
    /// </summary>
    public ViewSchedule TestingSchedule => _testingSchedule;

    /// <summary>
    ///     Настройки проверки ключевых спецификаций.
    /// </summary>
    public KeyScheduleRule KeyScheduleRule => _keyScheduleRule.KeyScheduleRule;
    ...
    public IEnumerable<RevitParam> GetNotExistsRequiredParamsInSchedule() {
        ...
        ScheduleDefinition definition = _testingSchedule.Definition;
