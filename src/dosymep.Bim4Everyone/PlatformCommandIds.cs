...
public static class PlatformCommandIds {
    ...
    /// </summary>
    public static readonly Guid CheckLevelsCommandId = new("52C48778-652D-42E7-B31C-D269E0619703");

    /// <summary>
    ///     Модуль настроек платформы.
    /// </summary>
    public static readonly Guid PlatformSettingsCommandId = new("5AEAB5FF-80AF-472C-B8B0-947DE2F808F1");


    /// <summary>
    ///     Вызов обновления СМР без интерфейса
    /// </summary>
    public static readonly Guid RevitSetCoordParamsHeadlessId = new("D036B85D-745F-4BE6-8513-EC7DCCA455BD");
}