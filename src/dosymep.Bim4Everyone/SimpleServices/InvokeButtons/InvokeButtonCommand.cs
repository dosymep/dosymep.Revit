...
internal class InvokeButtonCommand : ButtonCommand {
    public static readonly InvokeButtonCommand CheckLevelsCommand = new(
    ...
    public static readonly InvokeButtonCommand PlatformSettingsCommand = new(
    ...
    public static readonly InvokeButtonCommand SetCoordParamsHeadlessCommand = new(
        ...
        "RevitSetCoordParams.RevitSetCoordParamsCommandHeadless",
