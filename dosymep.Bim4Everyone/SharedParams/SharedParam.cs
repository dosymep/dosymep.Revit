...
namespace dosymep.Bim4Everyone.SharedParams {
    ...
    public class SharedParam : RevitParam {
        ...
        private readonly static Dictionary<string, string> _description = new Dictionary<string, string>() {
            ...
            { nameof(SharedParamsConfig.RoomGroupName), "Описание RoomGroupName" },
            { nameof(SharedParamsConfig.ApartmentGroupName), "Описание ApartmentGroupName" },
            { nameof(SharedParamsConfig.FireCompartmentName), "Описание FireCompartmentName" },
            { nameof(SharedParamsConfig.RoomSectionName), "Описание RoomSectionName" },
            { nameof(SharedParamsConfig.RoomTypeGroupName), "Описание RoomTypeGroupName" },
        ...
        private readonly static Dictionary<string, StorageType> _sharedParamTypes = new Dictionary<string, StorageType>() {
            ...
            { nameof(SharedParamsConfig.RoomGroupName), StorageType.String },
            { nameof(SharedParamsConfig.ApartmentGroupName), StorageType.String },
            { nameof(SharedParamsConfig.FireCompartmentName), StorageType.String },
            { nameof(SharedParamsConfig.RoomSectionName), StorageType.String },
            { nameof(SharedParamsConfig.RoomTypeGroupName), StorageType.String },
